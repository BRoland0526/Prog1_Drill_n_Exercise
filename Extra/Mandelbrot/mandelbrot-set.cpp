...
// Ennek a weboldal segitsegevel keszult el a program
...
int value (int x, int y){
	...
	complex<float> z(0, 0);
		...
		while (abs(z) < 2 && nb_iter <= 50){ //akkor lep ki a while-bol ha az adott komplex szam kilep a 2 sugaru korbol, vagy miutan megnezte mind az 50 iteraciot
			z = z * z + point;
			nb_iter++;
		}
